...
const cn = {
  ...
  Error: {
    Unauthorized:
       "为了防止滥用，已开启访问密码。\n前往公众号：[张锡寒AI Generated Content](https://mp.weixin.qq.com/s/NOHUQuUVTecprqAjXozjfw) 回复【密码】免费获取密码。\n然后点击左下角设置按钮，输入密码后解锁免费使用。\n\n卡顿？没有反应？或者提示：“You exceeded your current quota, please check your plan and billing details”\n可能是用户量太大，或者额度用完👉[点这里获得独立KEY使用](https://shoping.dzbz555.top/buy/1)\n\n防止域名失效，建议保存👉[我的主页](https://www.zxh.one/)，而不是本功能页\n\n👉[您的支持，是我更新的动力](https://shoping.dzbz555.top/buy/8)\n\n已补充额度并更新版本，更新时间：2023.10.13 11:48" ,
  },
  ChatItem: {
